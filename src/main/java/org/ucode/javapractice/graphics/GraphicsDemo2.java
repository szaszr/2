...
public class GraphicsDemo2 extends Canvas
{
    public void paint( Graphics g )
    {
        ...
        //   and has an arc length of 270 degrees
        ...
        g.fillArc(325,425,120,120,225,270); // chomp small
        ...
        Color mySpecialColor = new Color(36,26,185);
        g.setColor(mySpecialColor);
    ...
    {
        JFrame win = new JFrame("org.ucode.javapractice.graphics.GraphicsDemo2: Arcs and Colors");
        win.setSize(800,600);
