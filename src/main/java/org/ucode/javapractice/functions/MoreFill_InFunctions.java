...
/*
http://www.programmingbydoing.com/a/more-fill-in-functions.html
 */

import java.util.Scanner;

public class MoreFill_InFunctions {
    public static void main( String[] args )
    {
        ...
        int a=4,b=3,c=4,d=5,e=2,f=1, result;
        // project_grade();
	...
	//	int b;
	{
 	...
 	public static void step_count(int first, int last, int step )
	// Parameters are:
	//     int first;
	//     int last;
	//     int step;
