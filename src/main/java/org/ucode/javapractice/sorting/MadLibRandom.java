...
/*
http://www.programmingbydoing.com/a/madlib-random.html
 */
...
public class MadLibRandom {
    public static void main(String[] args) {
        ...
        int num1 = (int) (Math.random() * numbers.length); // number
        ...
        int adverb = (int) (Math.random() * adverbs.length);
